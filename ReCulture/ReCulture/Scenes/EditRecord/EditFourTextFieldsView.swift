...
protocol FourTextFieldsDelegate: AnyObject {
    
    /// 기록 상세 내용을 작성하는 뷰의 '간단한 후기' 내용이 모두 채워졌을 때 호출되는 메소드
    func shortReviewIsSet()
}

final class EditFourTextFieldsView: UIView {
...
//            parentVC.validateInputField()
    ...
    weak var delegate: FourTextFieldsDelegate?
...
//        textField3.placeholder = placeholderInfoList[2][1]
        ...
        textView4.text = withData[3]
        textView4.textColor = .rcGray600
    }
...
extension EditFourTextFieldsView: UITextViewDelegate {
